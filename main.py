...
def fetch_kol_insights():
    ...
    1. 核心宏观与贵金属：Luke Gromen, Ray Dalio, Daniel Ghali, Daniel Oliver, Jason Hunter, David Morgan, Rick Rule, Peter Schiff, Zoltan Pozsar, Steve Penny, Peter Krauth, Craig Hemke, Robert Kiyosaki, Willem Middelkoop, David Garofalo, James Rickards, Larry McDonald, David Stockman, Matthew Piepenburg, Clem Chambers, Ted Oakley, Jeffrey Gundlach, Stanley Druckenmiller.
    ...
    - "Sector": 大板块（如 "Precious Metals", "Macro", "Government Data"）。
    - "Detail_Sector": 细分板块。
